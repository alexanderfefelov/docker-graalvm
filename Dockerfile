...
ARG GRAALVM_JAVA_VERSION=8
ARG GRAALVM_HOME=/graalvm-ce-java$GRAALVM_JAVA_VERSION-$GRAALVM_VERSION
ARG GRAALVM_STUFF=graalvm-ce-java$GRAALVM_JAVA_VERSION-linux-amd64-$GRAALVM_VERSION.tar.gz
